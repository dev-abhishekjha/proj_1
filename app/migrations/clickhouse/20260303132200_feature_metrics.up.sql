-- Target table for the feature_metrics materialized view
-- Aggregated from feature_instances in 5-minute windows
...
PRIMARY KEY (feature_id, window_start, window_minutes)
ORDER BY (feature_id, window_start, window_minutes)
